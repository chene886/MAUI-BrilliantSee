...
namespace BrilliantSee.Models.Sources.NovelSources
{
    public class DingDianSource : Source
    {
        ...
        public override async Task<IEnumerable<Obj>> SearchAsync(string keyword)
        {
            ...
            {
                return Array.Empty<Obj>().Append(new DingDianNovel() { Cover = "https://i.postimg.cc/K8tdvsSZ/image.png", Name = "顶点源搜索需间隔30秒", Url = "https://www.ddxs.vip", Source = this, SourceName = Name, SourceCategory = Category });
            }
